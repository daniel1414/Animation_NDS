...
void Renderer::setClearColor(uint8 red, uint8 green, uint8 blue, uint8 alpha)
{
    glClearColor(red, green, blue, alpha);
}
void Renderer::setViewport(uint8 x1, uint8 y1, uint8 x2, uint8 y2)
{
    glViewport(x1, y1, x2, y2);
}
void Renderer::setMaterialProperty(GL_MATERIALS_ENUM mode, rgb color)
{
    glMaterialf(mode, color);
}
